...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection reward_ratio
     ...
     * @property Grid\Column|Collection recorded_at
     *
     ...
     * @method Grid\Column|Collection reward_ratio(string $label = null)
     ...
     * @method Grid\Column|Collection recorded_at(string $label = null)
     */
    class Grid {}
     ...
     * @property Show\Field|Collection reward_ratio
     ...
     * @property Show\Field|Collection recorded_at
     *
     ...
     * @method Show\Field|Collection reward_ratio(string $label = null)
     ...
     * @method Show\Field|Collection recorded_at(string $label = null)
     */
    class Show {}
